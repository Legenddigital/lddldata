...
func (s *BlockDataToMemdb) GetHeader(idx int) *lddljson.GetBlockHeaderVerboseResult {
	if idx < 0 {
		return nil
	}
	if s.mtx != nil {
...
func (s *BlockDataToMemdb) GetFeeInfo(idx int) *lddljson.FeeInfoBlock {
	if idx < 0 {
		return nil
	}
	if s.mtx != nil {
...
func (s *BlockDataToMemdb) GetStakeDiffEstimate(idx int) *lddljson.EstimateStakeDiffResult {
	if idx < 0 {
		return nil
	}
	if s.mtx != nil {
