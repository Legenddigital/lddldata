...
func (db *wiredDB) resyncDB(quit chan struct{}, blockGetter rpcutils.BlockGetter,
	...
	if stakeInfoHeight != summaryHeight {
		...
		return -1, fmt.Errorf("SQLite database (lddldata.sqlt.db) is corrupted")
	}
...
func (db *wiredDB) getBlock(ind int64) (*lddlutil.Block, *chainhash.Hash, error) {
