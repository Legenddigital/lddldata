...
// AgendaTagged has the same fields as lddljson.Agenda, but with the Id field
...
type AgendaTagged struct {
	...
	Choices        []lddljson.Choice `json:"choices"`
	VoteVersion    uint32            `json:"voteversion"`
}

// ChoiceLabeled embeds lddljson.Choice along with the AgendaID for the choice,
...
func CheckForUpdates(client *rpcclient.Client) error {
	...
	// https://docs.Legenddigital.org/getting-started/user-guides/agenda-voting/#voting-archive
